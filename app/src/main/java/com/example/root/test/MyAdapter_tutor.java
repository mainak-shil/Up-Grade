...
//    }
    ...
    public MyAdapter_tutor(Context context, int layout, ArrayList<Tutors> items) {
        super(context, layout);
        this.items=items;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.tv1.setText(items.get(position).tutorName);
        viewHolder.tv2.setText(items.get(position).tutorSubject);
